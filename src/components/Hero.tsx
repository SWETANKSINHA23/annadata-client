  ...
  return (
    <div className="transition-all duration-500 opacity-100 transform-none relative">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mt-6 animate-fade-up" style={{ animationDelay: "0.3s" }}>
        <Link to="/login"><button className="btn-primary flex items-center justify-center gap-2 w-full sm:w-auto">
          Login
          <ArrowRight className="w-5 h-5" />
        </button></Link>
        <Link to="/explore"><button className="btn-secondary flex items-center justify-center gap-2 w-full sm:w-auto">
          Explore
          <ArrowRight className="w-5 h-5" />
        </button></Link>
      </div>
